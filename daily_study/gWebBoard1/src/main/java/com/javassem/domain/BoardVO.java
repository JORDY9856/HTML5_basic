...
public class BoardVO {
	...
	public void setFile(MultipartFile file) {
		...
		if(! file.isEmpty()){
			...
			//***********************************************
			// 해당 경로로 변경 C:\Users\2402s\Documents\workspace_sts
			File f = new File("C:\\Users\\2402s\\Documents\\workspace_sts\\gWebBoard1\\src\\main\\webapp\\resources\\upload\\"+b_fname);
